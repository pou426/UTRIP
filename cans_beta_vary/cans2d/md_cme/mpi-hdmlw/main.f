...
c   setup numerical model (grid, initial conditions, etc.)
     ...
     &           ,igx,jgx,ipe,jpe)
      ...
      call p_bbtoaa_s(az,bx,by,dxm,dym,x,y,margin,ix,jx
     &           ,igx,jgx,ipe,jpe,ipex,jpex)
c     call exc_9(margin,ro,pr,vx,vy,vz,bx,by,bz,az,ix,jx
...
c     obtain time spacing
         ...
         safety=0.4d0
         dtmin=1.d-10
         call cfl_m3_s(dt,safety,dtmin,merr,gm,ro,pr,vx,vy,vz,bx,by,bz
     &       ,x,dx,ix,dy,jx)
         dtarr=(/dt,dble(-merr)/)
         dtarrg=(/0.d0,0.d0/)
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_m3_sg(ro,pr,vx,vy,vz,bx,by,bz,az,dt,qav,gm
     &                ,gx,gxm,gy,gym,x,xm,dx,dxm,ix,y,ym,dy,dym,jx)

         call model(1,ro,pr,vx,vy,vz,bx,by,bz,gm,t
     &     ,gx,gxm,gy,gym,margin,x,ix,y,jx,mf_params
     &           ,igx,jgx,ipe,jpe)
         call exc_9(margin,ro,pr,vx,vy,vz,bx,by,bz,az,ix,jx
