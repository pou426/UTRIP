c======================================================================|
      subroutine glr_h_g(ro,pr,vx,vy,x1,y1,dt,gm,gx,gy,
     &     dx1,ix,dy1,jx)
c======================================================================|
c
c NAME  glr_h
...
c    id: [integer] x-direction
c    jd: [integer] y-direction
c
c HISTORY
...
c----------------------------------------------------------------------|
      ...
      dimension x(ix,jx),dx(ix,jx),v(ix,jx),gx(ix,jx),gy(ix,jx)
      
      dimension ee(ix,jx),rx(ix,jx),ry(ix,jx),te(ix,jx),g(ix,jx)
...
c
         ...
         if(p1.le.0)write(*,*)'p1<=0',id,jd,i,j
