...
c   setup numerical model (grid, initial conditions, etc.)
     ...
     &    ,mf_params)
      ...
      call ciprdy_m(te,vxm,vym,bxm,bym
     ...
     &      ,ro,pr,vx,vy,bx,by,gm,dx,dxm,ix,dy,dym,jx)
      ...
      call saveini(tei,te,ix,jx)
      call saveini(rodxi,rodx,ix,jx)
      call saveini(rodyi,rody,ix,jx)
      call saveini(tedxi,tedx,ix,jx)
      call saveini(tedyi,tedy,ix,jx)

c     call bnd(margin,ro,pr,vx,vy,bx,by,az,ix,jx,roi,pri)
      call cipbnd(margin,ro,te,vxm,vym,bxm,bym,rodx,tedx,vxdxm,vydxm
     &       ,rody,tedy,vxdym,vydym,roi,rodxi,rodyi,tei,tedxi,tedyi
     &       ,ix,jx)
c     floor=1.d-9
...
c     solve hydrodynamic equations
         ...
         cvis=0.75d0
         call cip_m_g(ro,pr,vx,vxm,vy,vym,te
