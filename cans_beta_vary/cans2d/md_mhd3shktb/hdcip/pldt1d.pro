...
plot,s,pr1d(*,0),title='Pr',yrange=[0,1.2],linest=1
oplot,s,pr1d(*,n)

plot,s,ro1d(*,0),title='De',yrange=[0,1.2],linest=1
oplot,s,ro1d(*,n)

plot,s,te1d(*,0) ,yrange=[0.,5],title='Te',linest=1
oplot,s,te1d(*,n)

plot,s,vs1d(*,0),yr=[-0.4,0.8],title='Vs',linest=1
oplot,s,vs1d(*,n)

plot,s,vn1d(*,0),yr=[-1.7,0.2],title='Vn',linest=1,/yst
oplot,s,vn1d(*,n)

plot,s,bn1d(*,0)/sqrt(!pi*4),yr=[-1.2,1.2],title='Bn/sqrt(4pi)',linest=1,/yst
