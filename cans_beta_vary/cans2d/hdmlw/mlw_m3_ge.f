c======================================================================|
      subroutine mlw_m3_ge(ro,pr,vx,vy,vz,bx,by,bz,az,dt,qav,gm
     &                      ,gx,gxm,gy,gym,et,etm,dx,dxm,ix,dy,dym,jx)
c======================================================================|
c
c NAME  mlw_m3_g
c
...
c----------------------------------------------------------------------|
      ...
      call bbtocx(cx,bz,dy,ix,jx)
      call bbtocy(cy,bz,dx,ix,jx)
...
c----------------------------------------------------------------------|
      ...
      call bbtocx(cxh,bzh,dym,ix,jx)
      call bbtocy(cyh,bzh,dxm,ix,jx)
      call bbtocz(czh,bxh,byh,dxm,dym,ix,jx)
