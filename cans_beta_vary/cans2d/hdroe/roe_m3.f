c======================================================================|
      subroutine roe_m3(ro,pr,vx,vy,vz,bx,by,bz,az,dt,gm,dx,ix,dy,jx)
c======================================================================|
...
c----------------------------------------------------------------------|      
      ...
      dimension fro(ix,jx),fee(ix,jx),frx(ix,jx),fry(ix,jx),frz(ix,jx)
...
c----------------------------------------------------------------------|
      ...
      call roeflux_m3(fro,fee,fry,frx,frz,fbx,fbz,gm
     &               ,row,prw,vyw,vxw,vzw,byw,bxw,bzw,ix,jx)
...
c     computation of basic variables on half step
      ...
      do i=2,ix-1
         ...
         v2=vxh(i,j)**2+vyh(i,j)**2+vzh(i,j)**2
         b2=bxh(i,j)**2+byh(i,j)**2+bzh(i,j)**2
