...
c ----------------------------------------
c  NOTE: Due to a very special boundary condition of the MRI simulation,
c        ipex=1 should be kept unchanged.
c ----------------------------------------
...
c     call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,dvy,dt,yrgn,y,ix,jx,kx
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_m_t(ro,pr,vx,vy,vz,bx,by,bz,dt,qav,gm
     ...
     &       ,ipe,jpe,kpe,ipex,jpex,kpex,mper)
        call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,dvy,dt,yrgn,y,ix,jx,kx
