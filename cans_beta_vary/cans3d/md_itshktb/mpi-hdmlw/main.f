...
c     obtain time spacing
         ...
         safety=0.4d0
         dtmin=1.d-10
         call cfl_ht(dt,safety,dtmin,merr,cs2,vx,vy,vz
     &              ,dx,ix,dy,jx,dz,kx)
         dtarr=(/dt,dble(-merr)/)
         dtarrg=(/0.d0,0.d0/)
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_ht(ro,vx,vy,vz,dt,qav,cs2
     &            ,dx,dxm,ix,dy,dym,jx,dz,dzm,kx)

         call exc_4(margin,ro,vx,vy,vz,ix,jx,kx
     &       ,ipe,jpe,kpe,ipex,jpex,kpex,mper)
         call bnd(margin,ro,vx,vy,vz,ix,jx,kx
