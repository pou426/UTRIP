...
c----------------------------------------------------------------------|
      ...
      dimension da6(ix,jx,kx),da7(ix,jx,kx),da8(ix,jx,kx)
      parameter(mx=8)
...
c----------------------------------------------------------------------|
      ...
      do i=1,margin
         ...
         bufsndx(i,j,k,8)=da8(margin+i,j,k)
      enddo
      enddo
      enddo
     ...
     &    ,mpi_comm_world,mstatus,merr)
      ...
      do i=1,margin
         ...
         da8(ix-margin+i,j,k)=bufrcvx(i,j,k,8)
      enddo
      enddo
      enddo
      endif
...
c----------------------------------------------------------------------|
      ...
      do i=1,margin
         ...
         bufsndx(i,j,k,8)=da8(ix-2*margin+i,j,k)
      enddo
      enddo
      enddo
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix
         ...
         bufsndy(i,j,k,8)=da8(i,margin+j,k)
      enddo
      enddo
      enddo
     ...
     &    ,mpi_comm_world,mstatus,merr)
      ...
      do i=1,ix
         ...
         da8(i,jx-margin+j,k)=bufrcvy(i,j,k,8)
      enddo
      enddo
      enddo
      endif
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix
         ...
         bufsndy(i,j,k,8)=da8(i,jx-2*margin+j,k)
      enddo
      enddo
      enddo
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix
         ...
         bufsndz(i,j,k,8)=da8(i,j,margin+k)
      enddo
      enddo
      enddo
     ...
     &    ,mpi_comm_world,mstatus,merr)
      ...
      do i=1,ix
         ...
         da8(i,j,kx-margin+k)=bufrcvz(i,j,k,8)
      enddo
      enddo
      enddo
      endif
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix
         ...
         bufsndz(i,j,k,8)=da8(i,j,kx-2*margin+k)
      enddo
      enddo
      enddo
