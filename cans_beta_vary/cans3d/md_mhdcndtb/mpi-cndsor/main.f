...
c     data output
      ...
      write(mf_ro) ro
      mf_bx=15
      call dacdef3d(mf_bx,'bx.dac.'//cno,6,ix,jx,kx)
      write(mf_bx) bx
      mf_by=16
      call dacdef3d(mf_by,'by.dac.'//cno,6,ix,jx,kx)
      write(mf_by) by
      mf_bz=17
      call dacdef3d(mf_bz,'bz.dac.'//cno,6,ix,jx,kx)
      write(mf_bz) bz
...
c     solve conduction equation
         ...
         call p_cndsor_m(ro,pr,mi,err,dt,gm,rkap0,bx,by,bz
