c======================================================================|
      subroutine mlw_m_o(ro,pr,vx,vy,vz,dt,qav,gm
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix
         ...
         rysc(i,j,k) = ry*sc
         rzsc(i,j,k) = rz*sc
         bxsc(i,j,k) = bx(i,j,k)*hh(i,j,k,2)*hh(i,j,k,3)
         bysc(i,j,k) = by(i,j,k)*hh(i,j,k,3)*hh(i,j,k,1)
         bzsc(i,j,k) = bz(i,j,k)*hh(i,j,k,1)*hh(i,j,k,2)
      enddo
      enddo
      enddo
c----------------------------------------------------------------------|
...
c---  x-magnetic ---
      ...
      do i=1,ix
         ...
         fy(i,j,k)=  ez(i,j,k)
         fz(i,j,k)= -ey(i,j,k)
         fy(i,j,k)=  fy(i,j,k)*hh(i,j,k,3)
         fz(i,j,k)=  fz(i,j,k)*hh(i,j,k,2)
      enddo
      enddo
      enddo
...
c---  y-magnetic ---
      ...
      do i=1,ix
         ...
         fy(i,j,k)=  0.d0
         fz(i,j,k)=  ex(i,j,k)
         fx(i,j,k)=  fx(i,j,k)*hh(i,j,k,3)
         fz(i,j,k)=  fz(i,j,k)*hh(i,j,k,1)
      enddo
      enddo
      enddo
...
c---  z-magnetic ---
      ...
      do i=1,ix
         ...
         fy(i,j,k)= -ex(i,j,k)
         fz(i,j,k)=  0.d0
         fx(i,j,k)=  fx(i,j,k)*hh(i,j,k,2)
         fy(i,j,k)=  fy(i,j,k)*hh(i,j,k,1)
      enddo
      enddo
      enddo
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix-1
         ...
         bxh(i,j,k) = bxsch(i,j,k)/(hhm(i,j,k,2)*hhm(i,j,k,3))
         byh(i,j,k) = bysch(i,j,k)/(hhm(i,j,k,3)*hhm(i,j,k,1))
         bzh(i,j,k) = bzsch(i,j,k)/(hhm(i,j,k,1)*hhm(i,j,k,2))
         ...
         prh(i,j,k)   = (gm-1)*(eeh-0.5*roh(i,j,k)*vv-pmh(i,j,k))
      enddo
      enddo
      enddo
...
c---  x-magnetic ---
      ...
      do i=1,ix
         ...
         fy(i,j,k)=  ezh(i,j,k)
         fz(i,j,k)= -eyh(i,j,k)
         fy(i,j,k)=  fy(i,j,k)*hhm(i,j,k,3)
         fz(i,j,k)=  fz(i,j,k)*hhm(i,j,k,2)
      enddo
      enddo
      enddo
...
c---  y-magnetic ---
      ...
      do i=1,ix
         ...
         fy(i,j,k)=  0.d0
         fz(i,j,k)=  exh(i,j,k)
         fx(i,j,k)=  fx(i,j,k)*hhm(i,j,k,3)
         fz(i,j,k)=  fz(i,j,k)*hhm(i,j,k,1)
      enddo
      enddo
      enddo
...
c---  z-magnetic ---
      ...
      do i=1,ix
         ...
         fy(i,j,k)= -exh(i,j,k)
         fz(i,j,k)=  0.d0
         fx(i,j,k)=  fx(i,j,k)*hhm(i,j,k,2)
         fy(i,j,k)=  fy(i,j,k)*hhm(i,j,k,1)
      enddo
      enddo
      enddo
...
c----------------------------------------------------------------------|
      ...
      do i=2,ix-1
         ...
         bx(i,j,k) = bxsc(i,j,k)/(hh(i,j,k,2)*hh(i,j,k,3))
         by(i,j,k) = bysc(i,j,k)/(hh(i,j,k,3)*hh(i,j,k,1))
         bz(i,j,k) = bzsc(i,j,k)/(hh(i,j,k,1)*hh(i,j,k,2))
         vv=vx(i,j,k)**2+vy(i,j,k)**2+vz(i,j,k)**2
         bb=bb(i,j,k)**2+bb(i,j,k)**2+bb(i,j,k)**2
         pr(i,j,k) = (gm-1)*(ee - 0.5*ro(i,j,k)*vv -pi8i*bb)
      enddo
      enddo
      enddo
