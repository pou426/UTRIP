...
c     phat = M^{-1} p
      ...
      call exc_1(margin,work(1,1,1,phat),ix,jx,kx
     &           ,ipe,jpe,kpe,ipex,jpex,kpex,mper)
...
c      enddo
      ...
      do i=1+margin,ix-margin
         temp1=temp1+tmpv(i)
      enddo
      call mpi_allreduce(temp1,temp1g,1,mpi_double_precision,
...
c     shat = M^{-1} s 
      ...
      call exc_1(margin,work(1,1,1,shat),ix,jx,kx
     &           ,ipe,jpe,kpe,ipex,jpex,kpex,mper)
...
c      enddo
      ...
      do i=1+margin,ix-margin
         ...
         temp3=temp3+tmpu(i)
      enddo
      call mpi_allreduce(temp2,temp2g,1,mpi_double_precision,
     &     mpi_sum,mpi_comm_world,merr)
      temp2=temp2g
      call mpi_allreduce(temp3,temp3g,1,mpi_double_precision,
     &     mpi_sum,mpi_comm_world,merr)
      temp3=temp3g
      omega=temp2/temp3
