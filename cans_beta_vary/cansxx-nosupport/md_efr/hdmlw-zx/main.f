...
c======================================================================|
      ...
      data mfdim/1,0,1/
      parameter (margin=1)
      parameter (ix=64+2*margin,jx=1,kx=128+2*margin)
...
c     solve hydrodynamic equations
         ...
         call engine(ro,pr,vx,vy,vz,bx,by,bz,gz,gzm
     &          ,gm,mu,dt,dx,dxm,dy,dym,dz,dzm,ix,jx,kx,mfdim)

         call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,roi,pri,ix,jx,kx,mfdim)
c        floor=1.d-9
c        call chkdav(n_floor,ro,vx,vy,vz,floor,ix,jx,kx)
c        call chkdav(n_floor,pr,vx,vy,vz,floor,ix,jx,kx)
