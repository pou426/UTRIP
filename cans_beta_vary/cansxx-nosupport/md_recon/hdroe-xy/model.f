c======================================================================|
      subroutine model(ro,pr,vx,vy,vz,bx,by,bz,gm,et,etm
...
c   grid
c----------------------------------------------------------------------|
      dx0=xmax/dble(max(ix-margin*2,ix))
      do i=1,ix
         dxm(i)=dx0
      enddo
      ...
      dy0=ymax/dble(max(jx-margin*2,jx))
      do j=1,jx
         dym(j)=dy0
      enddo
      ...
      dz0=zmax/dble(max(kx-margin*2,kx))
      do k=1,kx
         dzm(k)=dz0
      enddo
