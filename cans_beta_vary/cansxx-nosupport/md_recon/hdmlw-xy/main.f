...
c======================================================================|
      ...
      data mfdim/1,1,0/
      parameter (margin=1)
      parameter (ix=128+2*margin,jx=128+2*margin,kx=1)
...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,pr,vx,vy,vz,bx,by,bz,gm,mu,et,etm
...
c     obtain time spacing
         ...
         safety=0.4d0
         dtmin=1.d-10
         call cfl_m_e(dt,safety,dtmin,merr,gm,ro,pr,vx,vy,vz,bx,by,bz
     &              ,et,dx,ix,dy,jx,dz,kx)
c        call cfl_m(dt,safety,dtmin,merr,gm,ro,pr,vx,vy,vz,bx,by,bz
c    &              ,dx,ix,dy,jx,dz,kx)
...
c     solve hydrodynamic equations
         ...
         call engine(ro,pr,vx,vy,vz,bx,by,bz,gm,mu,et,etm
