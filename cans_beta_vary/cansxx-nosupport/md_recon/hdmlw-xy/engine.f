c======================================================================|
      subroutine engine(ro,pr,vx,vy,vz,bx,by,bz,gm,mu,et,etm
     &                     ,dt,dx,dxm,dy,dym,dz,dzm,ix,jx,kx,mfdim)
c======================================================================|
...
c     call ohmideal(ex,ey,ez,bx,by,bz,vx,vy,vz,ix,jx,kx)
      call ohmet(ex,ey,ez,bx,by,bz,vx,vy,vz,et,dx,dy,dz,ix,jx,kx,mfdim)
      call mlw_mh(ro ,pr ,eh ,vx ,vy ,vz ,bx ,by ,bz ,ex ,ey ,ez 
...
c     call ohmideal(exh,eyh,ezh,bxh,byh,bzh,vxh,vyh,vzh,ix,jx,kx)
      call ohmet(exh,eyh,ezh,bxh,byh,bzh,vxh,vyh,vzh,etm
     &   ,dxm,dym,dzm,ix,jx,kx,mfdim)
      call mlw_mh(roh,prh,ehh,vxh,vyh,vzh,bxh,byh,bzh,exh,eyh,ezh
     &   ,ro2,ee2,rx2,ry2,rz2,bx2,by2,bz2
     &   ,roh,eeh,rxh,ryh,rzh,bxh,byh,bzh
