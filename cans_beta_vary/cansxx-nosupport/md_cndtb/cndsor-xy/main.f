...
c======================================================================|
      ...
      parameter (margin=1)
      parameter (mfdim=(/1,1,1/))
      parameter (margar=(/margin,margin,margin/))
      parameter (ix=32+2*margar(1),jx=32+2*margar(2),kx=1+2*margar(3))
