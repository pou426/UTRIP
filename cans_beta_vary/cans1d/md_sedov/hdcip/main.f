...
c======================================================================|
      ...
      dimension sc(ix),scm(ix),dv(ix),dsc(ix),dscm(ix)
...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,pr,vx,gm,sc,scm,dv,margin,x,ix,mf_params)
...
c     solve hydrodynamic equations
         ...
         cvis=1.50d0
         call cip_h_c(ro,pr,vx,te,vxm,rodx,tedx,vxdxm
     &         ,dt,cvis,gm,sc,scm,dx,dxm,ix)
