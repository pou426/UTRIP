c======================================================================|
      subroutine cip_m_bg(ro,pr,vx,vy,by,te,vxm,rodx,tedx,vxdxm,vyrdx
...
c----------------------------------------------------------------------|
      ...
      dimension roh(ix),teh(ix),vxmh(ix),vyrh(ix)
      dimension rodx(ix),tedx(ix),vxdxm(ix),vyrdx(ix)
      dimension rodxh(ix),tedxh(ix),vxdxmh(ix),vyrdxh(ix)
...
c--- ### important ### vx must be advanced first.
     ...
     &          +dt*gxm(i)
      ...
      do i=2,ix
        ...
        du=((vxm(i)+vxmh(i))*scm(i)-(vxm(i-1)+vxmh(i-1))*scm(i-1))/2
        teh(i)=teh(i)+dt*(-du/dx(i)*(gm-1)*gm*pr(i)/ro(i)/sc(i))
      enddo
