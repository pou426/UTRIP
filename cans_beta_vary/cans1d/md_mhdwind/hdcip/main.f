...
c   setup numerical model (grid, initial conditions, etc.)
     ...
     &           ,vstar,bx,bxm,gm,gx,gxm,rr,rrm,sc,scm,dv,margin,x,ix
     &     ,mf_params)
...
c     solve hydrodynamic equations
         ...
         cvis=1.00d0
         call  cip_m_bg(ro,pr,vx,vy,by,te,vxm,rodx,tedx,vxdxm,vydx
