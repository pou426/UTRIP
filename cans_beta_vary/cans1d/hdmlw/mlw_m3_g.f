c======================================================================|
      subroutine mlw_m3_g(ro,pr,vx,vy,vz,by,bz,bx,bxm,dt,qav,gm
     &     ,gx,gxm,gy,gym,gz,gzm,dx,dxm,ix)
c======================================================================|
c
c NAME  mlw_m3_g
c
...
c----------------------------------------------------------------------|
      ...
      dimension gy(ix), gym(ix)
      dimension gz(ix), gzm(ix)
c----------------------------------------------------------------------|
      pi = acos(-1.0d0)
      pi8i=1./pi/8.
      pi4i=1./pi/4.
...
c---  energy ---
      do i=1,ix
         ...
         ss(i)= ro(i)*(vx(i)*gx(i)+vy(i)*gy(i)+vz(i)*gz(i))
      enddo
...
c---  energy     ---
      do i=1,ix-1
         ...
         ss(i)= roh(i)*(vxh(i)*gxm(i)+vyh(i)*gym(i)+vzh(i)*gzm(i))
      enddo
...
c---  y-momentum ---
      ...
      call mlwsrcf(dry,dt,ss,ux0,ux1,ix)
...
c---  z-momentum ---
      ...
      call mlwsrcf(drz,dt,ss,ux0,ux1,ix)
