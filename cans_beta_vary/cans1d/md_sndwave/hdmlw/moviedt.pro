...
m=0 & namear[m]='ro' & dminar[m]=0.999990d0 & dmaxar[m]=1.06d0
m=1 & namear[m]='pr' & dminar[m]=0.59999 & dmaxar[m]=0.66d0
m=2 & namear[m]='vx' & dminar[m]=-3.00d-2 & dmaxar[m]=3.00d-2
...
for m=0,mx-1 do begin
    ...
    plot,x,data ,/xst,xrange=xrange,yrange=[dmin,dmax],ylog=dlogar[m] $
        ,title=name,xtitle='x'
