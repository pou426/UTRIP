...
c======================================================================|
      ...
      dimension sc(ix),scm(ix),dsc(ix),dscm(ix),dv(ix),dvm(ix)
...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,vx,cs2,g0,sc,scm,dv,dvm,margin,x,ix
     &     ,mf_params)
...
c    solve gravity equation
         xmc=0.d0
         call selfgint_c(gx,gxm,g0,ro,xmc,dv,dvm,x,dx,dxm,ix)

c----------------------------------------------------------------------|
c     solve hydrodynamic equations

         qav=0.3d0
         call mlw_ht_cg(ro,vx,dt,qav,cs2,gx,gxm,
