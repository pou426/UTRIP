...
m=1 & namear[m]='vy' & dminar[m]= 0.00d0 & dmaxar[m]=1.00d0
m=2 & namear[m]='ro' & dminar[m]=10.^(-7.0d0) & dmaxar[m]=10.^(-5.0d0) & dlogar[m]=1
m=3 & namear[m]='pr' & dminar[m]=10.^(-10.0d0) & dmaxar[m]=10.^(-5.0d0) & dlogar[m]=1
