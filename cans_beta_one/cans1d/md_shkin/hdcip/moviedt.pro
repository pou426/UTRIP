...
m=0 & namear[m]='ro' & dminar[m]=0.00d0 & dmaxar[m]=1.40d0
m=1 & namear[m]='pr' & dminar[m]=0.00d0 & dmaxar[m]=1.10d0
m=2 & namear[m]='vx' & dminar[m]=-1.20d0 & dmaxar[m]=1.20d0
...
for m=0,mx-1 do begin
    ...
    plot,x,data ,/xst,xrange=xrange,yrange=[dmin,dmax],title=name,xtitle='x'
