c======================================================================|
      subroutine mlw_m_g(ro,pr,vx,vy,by,bx,bxm,dt,qav,gm
     &                   ,gx,gxm,gy,gym,dx,dxm,ix)
c======================================================================|
c
c NAME  mlw_m_g
c
...
c----------------------------------------------------------------------|
      ...
      dimension dro(ix),dee(ix),drx(ix),dry(ix),dby(ix)
...
c---  energy     ---
      do i=1,ix-1
         ...
         ss(i)= roh(i)*(vxh(i)*gxm(i)+vyh(i)*gym(i))
      enddo
