...
m=0 & namear[m]='ro' & dminar[m]=0.00d0 & dmaxar[m]=1.40d1
m=1 & namear[m]='pr' & dminar[m]=-3.00d0 & dmaxar[m]=4.00d0 & dlogar[m]=1
m=2 & namear[m]='vx' & dminar[m]=-25.00d0 & dmaxar[m]=25.00d0
...
for m=0,mx-1 do begin
    ...
    if (m eq 0) then put_time,t[n],charsize=1.5,xp=0.01,yp=0.97,digit=5
