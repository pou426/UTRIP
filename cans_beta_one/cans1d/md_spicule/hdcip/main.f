...
c======================================================================|
      ...
      dimension te(ix),vxm(ix),rodx(ix),tedx(ix),vxdxm(ix),vyrdx(ix)
...
c   setup numerical model (grid, initial conditions, etc.)
     ...
     &     ,mf_params)
      ...
      call ciprdy_m_b(te,vxm,rodx,tedx,vxdxm,vyrdx,ro,pr,vx,vy
     &    ,gm,dx,dxm,rr,ix)
      call cipbnd(margin,te,vxm,vy,by,rodx,tedx,vxdxm,vyrdx
     & ,ro,dx,dxm,rr,ix)
...
c     data output
      ...
      close(mf_bx)
      mf_bxm=13
      call dacdef1d(mf_bxm,'bxm.dac',6,ix)
      write(mf_bxm) bxm
      close(mf_bxm)
      mf_sc=14
...
c     solve hydrodynamic equations
         ...
         cvis=0.75d0
         call cip_m_bg(ro,pr,vx,vy,by,te,vxm,rodx,tedx,vxdxm,vyrdx
     &    ,bx,bxm,dt,cvis,gm,gxm,sc,scm,rr,rrm,dx,dxm,ix)

c----------------------------------------------------------------------|
c     add source terms

         call trqalfven(vy,dt,t,x,ix)
         call bnd(margin,ro,pr,vx,vy,by,ix)
         call cipbnd(margin,te,vxm,vy,by,rodx,tedx,vxdxm,vyrdx
     &     ,ro,dx,dxm,rr,ix)
