c======================================================================|
      subroutine cip_m3_g(ro,pr,vx,vy,vz,by,bz,te,vxm
     &    ,rodx,tedx,vxdxm,vydx,vzdx
     &    ,bx,bxm,dt,cvis,gm,gxm,gy,gz,dx,dxm,ix)
c======================================================================|
c
c NAME  cip_m3_g
c
...
c----------------------------------------------------------------------|
      ...
      dimension  roh(ix),teh(ix),vxmh(ix),vyh(ix),vzh(ix)
     &          ,byh(ix),bzh(ix)
      dimension  rodx(ix),tedx(ix),vxdxm(ix),vydx(ix),vzdx(ix)
      dimension  rodxh(ix),tedxh(ix),vxdxmh(ix),vydxh(ix),vzdxh(ix)
      dimension  vym(ix),vzm(ix),bym(ix),bzm(ix)
      dimension  gxm(ix),gy(ix),gz(ix)
