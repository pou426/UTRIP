...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,pr,vx,vy,vz,gm,gx,gxm,gy,gym,gz,gzm
...
c     call exc_5(margin,ro,pr,vx,vy,vz,ix,jx,kx
c    &       ,ipe,jpe,kpe,ipex,jpex,kpex,mper)
      call bnd(margin,ro,pr,vx,vy,vz,ix,jx,kx,dzm
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_h_g(ro,pr,vx,vy,vz,dt,qav,gm,gx,gxm,gy,gym,gz,gzm
     &        ,dx,dxm,ix,dy,dym,jx,dz,dzm,kx)

         call exc_5(margin,ro,pr,vx,vy,vz,ix,jx,kx
