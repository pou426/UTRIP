...
c======================================================================|
      ...
      parameter (jx=  2/jpex+2*margin)
      parameter (kx=128/kpex+2*margin)
...
c        call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,roi,pri,ix,jx,kx
...
c     solve hydrodynamic equations
     ...
     &       ,ipe,jpe,kpe,ipex,jpex,kpex,mper)
         call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,roi,pri,ix,jx,kx
