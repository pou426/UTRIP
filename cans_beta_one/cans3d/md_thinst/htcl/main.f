...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,pr,gm,cool0,tecl0,decl0,margin,x,ix,y,jx,z,kx
     &   ,mf_params)
      call grdrdy(dx,xm,dxm,x,ix)
      call grdrdy(dy,ym,dym,y,jx)
      call grdrdy(dz,zm,dzm,z,kx)
      call htstdef(htst,gm,cool0,tecl0,decl0,ro,pr,ix,jx,kx)
      call pertub(pr,x,ix,y,jx,z,kx)
...
c     heating and cooling
         ...
         call htcl(ro,pr,dt,gm,cool0,tecl0,decl0,htst,ix,jx,kx)
