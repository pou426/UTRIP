...
iskip=1 & jskip=1 & scale=0.1 & limit=0.1
...
case ans of
  'ro' : begin
     data1=ro & dmin=0.d0 & dmax=0.8d0
   end
  'pr' : begin
     data1=pr & dmin=0.d0 & dmax=0.8d0
   end
  'te' : begin
     data1=te & dmin=0.9d0 & dmax=1.6d0
   end
endcase
...
; erase
  ...
  fccnve,/noerase,/noaxis,/nolabels $
    ...
    ,iskip=iskip,jskip=jskip,scale=scale,limit=limit,v_thick=1.5,v_color=0
  t3d,/yzexch
