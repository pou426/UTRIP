...
plot,s,vs_s0,yr=[-1.2,1.2],title='Vs',linest=1
oplot,s,vs_s

plot,s,vt_s0,yr=[-2.5,0.2],title='Vt',linest=1,/yst
oplot,s,vt_s

plot,s,bt_s0/sqrt(!pi*4),yr=[-1.5,1.5],title='Bt/sqrt(4pi)',linest=1,/yst
