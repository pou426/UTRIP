c======================================================================|
      subroutine mlw_ht_c(ro,vx,vy,vz,dt,qav,cs2
...
c======================================================================|
      ...
      dimension roh(ix,jx,kx),vxh(ix,jx,kx),vyh(ix,jx,kx),vzh(ix,jx,kx)
...
c---  y-momentum ---
      ...
      do i=1,ix
         ...
         fy(i,j,k)= (ro(i,j,k)*vy(i,j,k)**2+cs2*ro(i,j,k))/x(i)
...
c---  y-momentum ---
      ...
      do i=1,ix-1
         ...
         fy(i,j,k)= (roh(i,j,k)*vyh(i,j,k)**2+cs2*roh(i,j,k))/xm(i)
