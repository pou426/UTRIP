c======================================================================|
      subroutine mlw_m_ge(ro,pr,vx,vy,vz,bx,by,bz,dt,qav,gm
...
c----------------------------------------------------------------------|
      ...
      call bbtocx(cx,by,bz,dy,dz,ix,jx,kx)
      call bbtocy(cy,bz,bx,dz,dx,ix,jx,kx)
      call bbtocz(cz,bx,by,dx,dy,ix,jx,kx)
...
c---  energy ---
     ...
     &              +(by(i,j,k)*ex(i,j,k)-bx(i,j,k)*ey(i,j,k))*pi4i
         ss(i,j,k)= ro(i,j,k)*(vx(i,j,k)*gx(i,j,k)
     &                 +vy(i,j,k)*gy(i,j,k)+vz(i,j,k)*gz(i,j,k))
      enddo
      enddo
      enddo
...
c----------------------------------------------------------------------|
      ...
      call bbtocx(cxh,byh,bzh,dym,dzm,ix,jx,kx)
      call bbtocy(cyh,bzh,bxh,dzm,dxm,ix,jx,kx)
      call bbtocz(czh,bxh,byh,dxm,dym,ix,jx,kx)
...
c---  energy     ---
     ...
     &            +(byh(i,j,k)*exh(i,j,k)-bxh(i,j,k)*eyh(i,j,k))*pi4i
         ss(i,j,k)= roh(i,j,k)*(vxh(i,j,k)*gxm(i,j,k)
     &               +vyh(i,j,k)*gym(i,j,k)+vzh(i,j,k)*gzm(i,j,k))
      enddo
      enddo
      enddo
      call mlwfull(dee,dt
