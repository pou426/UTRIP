...
c======================================================================|
      ...
      dimension bx(ix,jx),bz(ix,jx),ay(ix,jx)
...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,pr,vx,vz,bx,bz,gm,margin,x,ix,z,jx,mf_params
     &           ,igx,jgx,ipe,jpe)
      mper=(/0,0/)
      call grdrdy(dx,xm,dxm,x,ix)
      call grdrdy(dz,zm,dzm,z,jx)
      call p_bbtoaa_c(ay,bz,bx,dzm,dxm,x,margin,ix,jx
     &           ,igx,jgx,ipe,jpe,ipex,jpex)
c     call exc_7(margin,ro,pr,vx,vz,bx,bz,ay,ix,jx
...
c     solve hydrodynamic equations
     ...
     &          ,dt,qav,gm,x,xm,dx,dxm,ix,dz,dzm,jx)
         ...
         call exc_7(margin,ro,pr,vx,vz,bx,bz,ay,ix,jx
