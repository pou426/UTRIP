c======================================================================|
      subroutine exc_9(margin,da1,da2,da3,da4,da5,da6,da7,da8,da9
...
c----------------------------------------------------------------------|
      ...
      do i=1,margin
         ...
         bufsndx(i,j,5)=da5(margin+i,j)
         bufsndx(i,j,6)=da6(margin+i,j)
         bufsndx(i,j,7)=da7(margin+i,j)
         bufsndx(i,j,8)=da8(margin+i,j)
         bufsndx(i,j,9)=da9(margin+i,j)
      enddo
      enddo
     ...
     &    ,mpi_comm_world,mstatus,merr)
      ...
      do i=1,margin
         ...
         da5(ix-margin+i,j)=bufrcvx(i,j,5)
         da6(ix-margin+i,j)=bufrcvx(i,j,6)
         da7(ix-margin+i,j)=bufrcvx(i,j,7)
         da8(ix-margin+i,j)=bufrcvx(i,j,8)
         da9(ix-margin+i,j)=bufrcvx(i,j,9)
      enddo
      enddo
      endif
...
c----------------------------------------------------------------------|
      ...
      do i=1,margin
         ...
         bufsndx(i,j,5)=da5(ix-2*margin+i,j)
         bufsndx(i,j,6)=da6(ix-2*margin+i,j)
         bufsndx(i,j,7)=da7(ix-2*margin+i,j)
         bufsndx(i,j,8)=da8(ix-2*margin+i,j)
         bufsndx(i,j,9)=da9(ix-2*margin+i,j)
      enddo
      enddo
     ...
     &     ,mpi_comm_world,mstatus,merr)
      ...
      do i=1,margin
         ...
         da5(i,j)=bufrcvx(i,j,5)
         da6(i,j)=bufrcvx(i,j,6)
         da7(i,j)=bufrcvx(i,j,7)
         da8(i,j)=bufrcvx(i,j,8)
         da9(i,j)=bufrcvx(i,j,9)
      enddo
      enddo
      endif
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix
         ...
         bufsndy(i,j,5)=da5(i,margin+j)
         bufsndy(i,j,6)=da6(i,margin+j)
         bufsndy(i,j,7)=da7(i,margin+j)
         bufsndy(i,j,8)=da8(i,margin+j)
         bufsndy(i,j,9)=da9(i,margin+j)
      enddo
      enddo
     ...
     &    ,mpi_comm_world,mstatus,merr)
      ...
      do i=1,ix
         ...
         da5(i,jx-margin+j)=bufrcvy(i,j,5)
         da6(i,jx-margin+j)=bufrcvy(i,j,6)
         da7(i,jx-margin+j)=bufrcvy(i,j,7)
         da8(i,jx-margin+j)=bufrcvy(i,j,8)
         da9(i,jx-margin+j)=bufrcvy(i,j,9)
      enddo
      enddo
      endif
...
c----------------------------------------------------------------------|
      ...
      do i=1,ix
         ...
         bufsndy(i,j,5)=da5(i,jx-2*margin+j)
         bufsndy(i,j,6)=da6(i,jx-2*margin+j)
         bufsndy(i,j,7)=da7(i,jx-2*margin+j)
         bufsndy(i,j,8)=da8(i,jx-2*margin+j)
         bufsndy(i,j,9)=da9(i,jx-2*margin+j)
      enddo
      enddo
     ...
     &                 ,mpi_comm_world,mstatus,merr)
      ...
      do i=1,ix
         ...
         da5(i,j)=bufrcvy(i,j,5)
         da6(i,j)=bufrcvy(i,j,6)
         da7(i,j)=bufrcvy(i,j,7)
         da8(i,j)=bufrcvy(i,j,8)
         da9(i,j)=bufrcvy(i,j,9)
      enddo
      enddo
      endif
