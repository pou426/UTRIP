c======================================================================|
      subroutine ccfspt_m(cmat,src,rkap0,gm,dt,te,ro,bx,by
     &              ,dx,dxm,ix,dy,dym,jx)
c======================================================================|
c
c NAME  ccfspt_m
...
c    aa0=0 & src=0   for Laplace equation
c    aa0=0 & src=!0  for Poisson equation
...
c-----------------------------------------------------------------------
     ...
     &      +ayx(i  ,j  )/dx(i)/dy(j)*(teh(i  ,j  )-teh(i-1,j  ))
     &      -ayx(i  ,j-1)/dx(i)/dy(j)*(teh(i  ,j-1)-teh(i-1,j-1))
       enddo
       enddo
