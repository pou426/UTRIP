...
c  file open
      ...
      mf_bz=27
      call dacdef2s(mf_bz,'bz.dac.'//cno,6,ix,jx)
      mf_ay=28
      call dacdef2s(mf_ay,'ay.dac.'//cno,6,ix,jx)
...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,pr,vx,vy,vz,bx,by,bz
     ...
     &           ,igx,jgx,ipe,jpe)
      ...
      call p_bbtoaa_t(ay,bz,bx,dzm,dxm,margin,ix,jx
     &           ,igx,jgx,ipe,jpe,ipex,jpex)
c     call exc_9(margin,ro,pr,vx,vy,vz,bx,by,bz,ay,ix,jx
c    &       ,ipe,jpe,ipex,jpex,mper)
c     call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,ay,ix,jx
c    &           ,ipe,jpe,ipex,jpex)
c     floor=1.d-9
...
c  read-data
      ...
      mfi_bz=77
      call dacopnr2s(mfi_bz,'in/bz.dac.'//cno,mtype,ix0,jx0,nx0)
      mfi_ay=78
      call dacopnr2s(mfi_ay,'in/ay.dac.'//cno,mtype,ix0,jx0,nx0)
      do n=1,ndi
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_m3_t(ro,pr,vx,vy,vz,bx,by,bz,ay,dt,qav,gm
     &              ,omega0,qt0,x,xm,dx,dxm,ix,dz,dzm,jx)

         call exc_9(margin,ro,pr,vx,vy,vz,bx,by,bz,ay,ix,jx
     &           ,ipe,jpe,ipex,jpex,mper)
         call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,ay,dvy,ix,jx
     &           ,ipe,jpe,ipex,jpex)
c        floor=1.d-9
c        call chkdav(n_floor,ro,vx,vz,floor,ix,jx)
c        call chkdav(n_floor,pr,vx,vz,floor,ix,jx)
