c======================================================================|
      subroutine p_cndsor_s(ro,pr,mi,err,dt,gm,rkap0
     &           ,margin,x,xm,y,ym,dx,dxm,ix,dy,dym,jx,jgx,myrank,npe)
c======================================================================|
c
c NAME  cndsor_s
c
...
c----------------------------------------------------------------------|
      ...
      call ccfspt_s(cmat,src,rkap0,gm,dt,te,ro
     &                   ,x,xm,y,ym,dx,dxm,ix,dy,dym,jx)
c     call ccfunf_s(cmat,src,rkap0,gm,dt,te,ro
c    &                   ,x,xm,y,ym,dx,dxm,ix,dy,dym,jx)
