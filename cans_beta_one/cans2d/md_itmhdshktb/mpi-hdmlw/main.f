...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,vx,vy,bx,by,cs2,margin,x,ix,y,jx,mf_params
     &           ,igx,jgx,ipe,jpe)
      mper=(/0,0/)
...
c     call exc_6(margin,ro,vx,vy,bx,by,az,ix,jx
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_mt(ro,vx,vy,bx,by,az,dt,qav,cs2,dx,dxm,ix,dy,dym,jx)

         call exc_6(margin,ro,vx,vy,bx,by,az,ix,jx
