...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,vx,vy,cs2,margin,x,ix,y,jx
     &       ,mf_params,igx,jgx,ipe,jpe)
      mper=(/0,0/)

      call grdrdy(dx,xm,dxm,x,ix)
      call grdrdy(dy,ym,dym,y,jx)
c     call exc_3(margin,ro,vx,vy,ix,jx,ipe,jpe,ipex,jpex,mper)
c     call bnd(margin,ro,vx,vy,ix,jx,ipe,jpe,ipex,jpex)
c     floor=1.d-9
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_ht(ro,vx,vy,dt,qav,cs2,dx,dxm,ix,dy,dym,jx)

         call exc_3(margin,ro,vx,vy,ix,jx,ipe,jpe,ipex,jpex,mper)
         call bnd(margin,ro,vx,vy,ix,jx,ipe,jpe,ipex,jpex)
c        floor=1.d-9
c        call chkdav(n_floor,ro,vx,vy,floor,ix,jx)
