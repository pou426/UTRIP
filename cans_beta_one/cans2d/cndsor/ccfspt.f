c======================================================================|
      subroutine ccfspt(cmat,src,rkap0,gm,dt,te,ro,dx,dxm,ix,dy,dym,jx)
c======================================================================|
c
c NAME  ccfspt
c
...
c        te00=0.5*(te(i,j)+te(i+1,j))
         ...
         axx(i,j)=rkap0*sqrt(min(te00,telim))**5
      enddo
      enddo
...
c        te00=0.5*(te(i,j)+te(i,j+1))
         ...
         ayy(i,j)=rkap0*sqrt(min(te00,telim))**5
      enddo
      enddo
