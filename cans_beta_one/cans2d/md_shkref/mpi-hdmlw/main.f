...
c======================================================================|
      ...
      parameter (margin=1)
      parameter (ix=512/ipex+2*margin)
...
c        call exc_4(margin,ro,pr,vx,vy,ix,jx
c    &           ,ipe,jpe,ipex,jpex,mper)
c        call bnd(margin,ro,pr,vx,vy,gm,time,x,y
c    &        ,rmach,xedge,thetain,ro0,pr0,vx0,vy0,ix,jx
c    &           ,ipe,jpe,ipex,jpex)
c     floor=1.d-9
...
c     solve hydrodynamic equations
         ...
         qav=3.d0
         call mlw_h(ro,pr,vx,vy,dt,qav,gm,dx,dxm,ix,dy,dym,jx)

         call exc_4(margin,ro,pr,vx,vy,ix,jx,ipe,jpe,ipex,jpex,mper)
         call bnd(margin,ro,pr,vx,vy,gm,time,x,y
