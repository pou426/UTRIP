...
c  file open
      ...
      call dacputparamc(mf_params,'comment','cans2d md_coalescence')
...
c----------------------------------------------------------------------|
c   setup numerical model (perturbation)

      call pertub(vx,x,ix,y,jx)
...
c     obtain time spacing
         ...
         safety=0.4d0
         dtmin=1.d-10
         call cfl_m_e(dt,safety,dtmin,merr,gm,ro,pr,vx,vy,bx,by,et
     &      ,dx,ix,dy,jx)
...
c                                                      hdmlw - start >>>
         qav=3.d0
         call mlw_m_e(ro,pr,vx,vy,bx,by,az,dt,qav,gm
