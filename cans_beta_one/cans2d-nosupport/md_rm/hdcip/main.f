...
c  file open
      ...
      call dacputparamc(mf_params,'comment','cans2d md_rm')
...
c                                                      hdcip - start >>>
      call ciprdy_h(te,vxm,vym
     &      ,rodx,tedx,vxdxm,vydxm,rody,tedy,vxdym,vydym
     &      ,ro,pr,vx,vy,gm,dx,dxm,ix,dy,dym,jx)
      call cipbnd(margin,ro,te,vxm,vym,rodx,tedx,vxdxm,vydxm
...
c                                                      hdcip - start >>>
         cvis=0.75d0
         call cip_h(ro,pr,vx,vxm,vy,vym,te
