...
c  file open
      ...
      call dacputparamc(mf_params,'comment','cans2d md_loopexp')
...
c     ready
      ...
      call saveini(byi,by,ix,jx)

      call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,az,byi,x,time,ix,jx)
      floor=1.d-9
