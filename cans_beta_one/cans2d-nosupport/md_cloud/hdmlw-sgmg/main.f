...
c  file open
      ...
      call dacputparamc(mf_params,'comment','cans2d md_cloud')
...
c   setup numerical model (grid, initial conditions, etc.)
      ...
      call model(ro,vx,vy,cs2,g0,margin,x,ix,y,jx
     &    ,mf_params)
      call bnd(margin,ro,vx,vy,ix,jx)
      floor=1.d-9
...
c                                                      hdmlw - start >>>
         qav=3.d0
         call mlw_ht_g(ro,vx,vy,dt,qav,cs2,gx,gxm,gy,gym
     &                ,dx,dxm,ix,dy,dym,jx)
c                                                      hdmlw - end   <<<
