...
c        qav=3.d0
c        call mlw_m_sg(ro,pr,vx,vy,vz,bx,by,bz,dt,qav,gm
c    &          ,gx,gxm,gy,gym,gz,gzm
c    &          ,x,xm,dx,dxm,ix,y,ym,dy,dym,jx,dz,dzm,kx)
         call engine(ro,pr,vx,vy,vz,bx,by,bz,x,xm,y,ym,gx,gxm
