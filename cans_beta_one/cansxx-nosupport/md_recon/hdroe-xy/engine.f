c======================================================================|
      subroutine engine(ro,pr,vx,vy,vz,bx,by,bz,gm,et,etm
...
c======================================================================|
      ...
      dimension etx(ix,jx,kx),ety(ix,jx,kx),etz(ix,jx,kx)
...
c----------------------------------------------------------------------|
     ...
     &   ,gm,dth,dx,dy,dz,ix,jx,kx,mfdim,1)
      call exp_et(bxh,byh,bzh,eeh,bx,by,bz
     &    ,et,mu,dth,dx,dxm,dy,dym,dz,dzm,ix,jx,kx,mfdim,mfdim3)
     ...
     &   ,gm,dt,dx,dy,dz,ix,jx,kx,mfdim,2)
      call exp_et(bx2,by2,bz2,ee2,bxh,byh,bzh
