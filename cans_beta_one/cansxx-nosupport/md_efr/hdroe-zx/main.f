...
c======================================================================|
      ...
      parameter (margin=1)
      parameter (ix=64+2*margin,jx=1+2*margin,kx=128+2*margin)
...
c   setup numerical model (grid, initial conditions, etc.)
     ...
     &            ,gx,gxm,gy,gym,gz,gzm,margin,x,ix,y,jx,z,kx,mf_params)
      ...
      call saveini(roi,ro,ix,jx,kx)
      call saveini(pri,pr,ix,jx,kx)
c     call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,ix,jx,kx,roi,pri)
c     floor=1.d-9
...
c        qav=3.d0
c        call mlw_m_g(ro,pr,vx,vy,vz,bx,by,bz,dt,qav,gm
c    &            ,gx,gxm,gy,gym,gz,gzm,dx,dxm,ix,dy,dym,jx,dz,dzm,kx)

         call engine(ro,pr,vx,vy,vz,bx,by,bz,gx,gxm,gy,gym,gz,gzm
     &               ,gm,dt,dx,dxm,dy,dym,dz,dzm,ix,jx,kx)

         call bnd(margin,ro,pr,vx,vy,vz,bx,by,bz,ix,jx,kx,roi,pri)
         floor=1.d-9
