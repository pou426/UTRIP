c======================================================================|
      subroutine engine(ro,pr,vx,vy,vz,bx,by,bz,gz,gzm
...
c----------------------------------------------------------------------|
     ...
     &   ,mu,dt,dx,dxm,dy,dym,dz,dzm,ix,jx,kx,mfdim,mfdim3,1)
      call mlw_gv(ro ,vz ,gz
     &  ,ee2,rz2,eeh,rzh
     &  ,dt,dx,dxm,dy,dym,dz,dzm,ix,jx,kx,mfdim,1)
     ...
     &   ,mu,dt,dx,dxm,dy,dym,dz,dzm,ix,jx,kx,mfdim,mfdim3,2)
      call mlw_gv(roh,vzh,gzm
     &  ,ee2,rz2,eeh,rzh
     &  ,dt,dx,dxm,dy,dym,dz,dzm,ix,jx,kx,mfdim,2)
